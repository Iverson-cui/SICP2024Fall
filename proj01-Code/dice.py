...
# Every time four_sided and six_sided are called, different results are returned.
# These two are functions. To get the result of a roll, you need to call them like this:
# four_sided() or six_sided().
